...
public class MessageConstants {
    ...
    public static final String FIRST_NAME_LENGTH = "First Name must be between 3 and 100 characters";
    public static final String LAST_NAME_MAX_LENGTH = "Last name cannot exceed 100 characters";
    ...
    public static final String DATE_OF_BIRTH_FORMAT = "Date of birth must be in YYYY-MM-DD format";
    public static final String ROLE_REQUIRED = "Role is required";
    public static final String ROLE_INVALID = "Role must be either CUSTOMER, ADMIN, or SELLER";
